...
export const legacyInvoiceKeys = {
  listScope: (scope: LegacyCommerceBusinessUnitScope, branchId: string | null) => ["commerce", "legacy-invoices", scope.workspaceId.trim(), scope.legacyBusinessUnitId.trim(), branchId?.trim() ?? null, "list"] as const,
