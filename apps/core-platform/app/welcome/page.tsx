      ...
      <div className="nx-welcome-stage">
        <div className="nx-welcome-card nx-pop">
          <div className="nx-welcome-card-top">
            <div className="nx-welcome-card-mark">
              {/* eslint-disable-next-line @next/next/no-img-element -- Welcome uses the runtime public animated brand asset directly. */}
              <img src="/branding/nexoraxs_wave_animated.svg" alt="NexoraXS" />
            </div>
